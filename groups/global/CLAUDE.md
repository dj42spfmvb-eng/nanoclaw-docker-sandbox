...
<!-- Set your timezone in .env: TZ=America/Your_City -->
Use the timezone configured in the TZ environment variable. When scheduling tasks, reminders, or interpreting time references, use the configured timezone. When displaying times to users, include the timezone abbreviation.
